    ...
    <>
      <Card>
        <div className="flex justify-between	mb-4 gap-5">
          ...
          <div>
            <Search
              placeholder="Search by Drop zone name"
              onSearch={onSearch}
              style={{
                width: 250,
              }}
            ...
            <Button
              ...
              icon={<PlusOutlined />}
              className="mx-1.5 cursor-pointer"
              onClick={() => navigate("/add-drop-zone")}
            >
              Add Drop zone
            </Button>
          </div>
            ...
            <thead className=" text-gray-700 capitalize text-xs	 bg-gray-50">
              <tr>
                <th scope="col" className="px-3 py-3 whitespace-nowrap">
                  Name (English) <SortingArrow onSort={handleSort} />
                </th>
                <th scope="col" className="px-3 py-3">
                  Address <SortingArrow onSort={handleSort} />
                </th> 
                <th scope="col" className="px-3 py-3">
                  Discount % <SortingArrow onSort={handleSort} />
                </th>
                <th scope="col" className="px-3 py-3">
            ...
            <tbody>
              <tr className="bg-white border-b">
                <td className="px-3 py-4 vertical-top">
                  RabbitHole Branch Yasmin
                </td>
                <td className="px-3 py-4 vertical-top">
                  RFDA3166، 3166 ابي جعفر المنصور، 7396، حي الشهداء، الرياض
                  13241
                </td>
                <td className="px-3 py-4 vertical-top">12</td>
                <td className="px-3 py-4 vertical-top">
                  1000000 cm<sup>3</sup>
                </td>
                <td className="px-3 py-4 vertical-top">
                  <Switch />
                </td>
      ...
      <ConfirmationModal
        ...
        ConfirmationParagraph="Are you sure you want to delete this Drop zone?"
